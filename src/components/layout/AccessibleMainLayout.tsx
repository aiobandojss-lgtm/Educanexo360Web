...
import { getSkipLinkProps, getSkipLinkTargetProps, initFocusTrap } from '../../utils/accessibilityUtils';
...
const AccessibleMainLayout = () => {
  ...
  useEffect(() => {
    ...
    if (!document.querySelector('meta[name="description"]')) {
      ...
      metaDesc.content = 'Sistema de comunicación escolar para conectar instituciones educativas, docentes, estudiantes y padres de familia';
  ...
  const skipToMainProps = getSkipLinkProps('Saltar al contenido principal', 'main-content');
  const skipToMenuProps = getSkipLinkProps('Saltar al menú de navegación', 'navigation-menu');
